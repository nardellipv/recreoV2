...
class UpdateStudentRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'dni_student' => 'required | numeric | unique:students,dni_student,' . $student->id,
            'birth_date' => 'required',
            'level_student' => 'required',
            'classroom' => 'required',
            'genre' => 'required',
            'phone_student' => 'required | numeric | unique:students,phone_student,' . $student->id,
            'email_student' => 'required | email | unique:students,email_student,' . $student->id,
    ...
    public function messages()
    {
        return [
            ...
            'dni_student.required' => 'El DNI es requerido',
            'dni_student.numeric' => 'El DNI debe ser numérico',
            'dni_student.unique' => 'El DNI ya se encuentra registrado',
            ...
            'phone_student.unique' => 'El teléfono ya se encuentra registrado',
