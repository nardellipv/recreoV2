                ...
                <div class="col-12 col-md-12 col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4>Editar Alumno {{ $student->name_student }}</h4>
                        </div>
                        <form action="{{ route('student.update', $student) }}" method="POST">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text"
                                            ...
                                            name="name_student" placeholder="Nombre"
                                            value="{{ old('name_student', $student->name_student) }}" required>
                                        @error('name_student')
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('lastname_student', $student->lastname_student) }}" required>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text"
                                            ...
                                            name="dni_student" placeholder="DNI"
                                            value="{{ old('dni_student', $student->dni_student) }}" required>
                                        @error('dni_student')
                                            <span class="invalid-feedback"
                                                role="alert"><strong>{{ $message }}</strong></span>
                                        @enderror
                                        ...
                                        @foreach (['1' => 'Nivel 1', '2' => 'Nivel 2'] as $val => $label)
                                            <label class="selectgroup-item form-check form-check-inline">
                                                <input type="radio" name="level_student" value="{{ $val }}"
                                                    ...
                                                    {{ old('level_student', $student->level_student) == $val ? 'checked' : '' }}>
                                        ...
                                        @foreach (['PRIMARIA' => 'Primaria', 'SECUNDARIA' => 'Secundaria'] as $val => $label)
                                            <label class="selectgroup-item form-check form-check-inline">
                                                <input type="radio" name="classroom" value="{{ $val }}"
                                                    class="selectgroup-input-radio" required
                                                    {{ old('classroom', $student->classroom) == $val ? 'checked' : '' }}>
                                                <span class="selectgroup-button">{{ $label }}</span>
                                            </label>
                                        @endforeach
                                        @error('classroom')
                                        ...
                                        @foreach (['SI' => 'Sí', 'NO' => 'No'] as $val => $label)
                                            <label class="selectgroup-item form-check form-check-inline">
                                                <input type="radio" name="have_beca" value="{{ $val }}"
                                                    class="selectgroup-input-radio" required {{-- Modificación aquí --}}
                                                    {{ old('have_beca', $student->have_beca ?? null) == $val ? 'checked' : '' }}>
                                                <span class="selectgroup-button">{{ $label }}</span>
                                            </label>
                                        @endforeach
                                        @error('have_beca')
                                        ...
                                        @foreach (['SI' => 'Participo por primera vez', 'NO' => 'Ya he participado con anterioridad'] as $val => $label)
                                            <label class="selectgroup-item form-check form-check-inline">
                                                <input type="radio" name="first_time_student"
                                                    ...
                                                    {{ old('first_time_student', $student->first_time_student) == $val ? 'checked' : '' }}>
                                                <span class="selectgroup-button">{{ $label }}</span>
                                            </label>
                                        @endforeach
                                        ...
                                        @foreach (['MASCULINO' => 'Masculino', 'FEMENINO' => 'Femenino'] as $val => $label)
                                            <label class="selectgroup-item form-check form-check-inline">
                                                <input type="radio" name="genre" value="{{ $val }}"
                                                    class="selectgroup-input-radio" required
                                                    {{ old('genre', $student->genre) == $val ? 'checked' : '' }}>
                                                <span class="selectgroup-button">{{ $label }}</span>
                                            </label>
                                        @endforeach
                                        @error('genre')
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary btn-block">Editar Alumno</button>
                            </div>
                        </form>
                    </div>
                </div>
